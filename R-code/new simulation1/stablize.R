...
do.oneZ.corr <- function(trials)
{
  ...
  #
  fitm.mar <- glm(M~A+U1+U2+U3+U1*U2+U2*U3+U1*U3,family = binomial(link = "logit"),data = dataset.Z)
  fitc.mar <- glm(C~A+U1+U2+U3+U1*U2+U2*U3+U1*U3,family = binomial(link = "logit"),data = dataset.Z)
  fita <- glm(A~U1+U2+U3+U1*U2+U2*U3+U1*U3,family = binomial(link = "logit"),data = dataset.Z)
  fity <- lm(Y~A+U1+U2+U3+C+M + A*C+A*M+U1*U2+U2*U3+U1*U3,data = dataset.Z)

  ###########  
  weighta <- (dataset.Z$A*fitted(fita)+(1-dataset.Z$A)*(1-fitted(fita)))^(-1)
  fitc.mar.stable <- glm(cbind(C,1-C)~A+U1+U2+U3+U1*U2+U2*U3+U1*U3,family = binomial(link = "logit"),data = dataset.Z,
                         weights = weighta)
  fitm.mar.stable <- glm(cbind(M,1-M)~A+U1+U2+U3+U1*U2+U2*U3+U1*U3,family = binomial(link = "logit"),data = dataset.Z,
                         weights = weighta)
  
  fc.stable <- fitted(fitc.mar.stable)
  fm.stable <- fitted(fitm.mar.stable)
  datam0 <- data.frame(0,dataset.Z$U1,dataset.Z$U2,dataset.Z$U3)
  colnames(datam0) <- c("A","U1","U2","U3")
  ...
  fity.stable <- lm(Y~A+U1+U2+U3+C+M+ A*C+A*M+U1*U2+U2*U3+U1*U3,data = dataset.Z,weights=weight1)
...
do.oneZ.m<-function(trials)
{
  dataset.Z <- data_genZ(n)
  #
  fitm.mar <- glm(M~A+U1+U2+U3,family = binomial(link = "logit"),data = dataset.Z)
  fitc.mar <- glm(C~A+U1+U2+U3+U1*U2+U2*U3+U1*U3,family = binomial(link = "logit"),data = dataset.Z)
  fita <- glm(A~U1+U2+U3+U1*U2+U2*U3+U1*U3,family = binomial(link = "logit"),data = dataset.Z)
  fity <- lm(Y~A+U1+U2+U3+C+M + A*C+A*M+U1*U2+U2*U3+U1*U3,data = dataset.Z)
  ...
  fitc.mar.stable <- glm(cbind(C,1-C)~A+U1+U2+U3+U1*U2+U2*U3+U1*U3,family = binomial(link = "logit"),data = dataset.Z,
                         weights = weighta)
  fitm.mar.stable <- glm(cbind(M,1-M)~A+U1+U2+U3,family = binomial(link = "logit"),data = dataset.Z,
                         weights = weighta)
...
do.oneZ.mc <-function(trials)
{
  ...
  #
  fitm.mar <- glm(M~A+U1+U2+U3,family = binomial(link = "logit"),data = dataset.Z)
  fitc.mar <- glm(C~A+U1+U2+U3,family = binomial(link = "logit"),data = dataset.Z)
  fita <- glm(A~U1+U2+U3+U1*U2+U2*U3+U1*U3,family = binomial(link = "logit"),data = dataset.Z)
  fity <- lm(Y~A+U1+U2+U3+C+M + A*C+A*M+U1*U2+U2*U3+U1*U3,data = dataset.Z)
  
  ###########  
  weighta <- (dataset.Z$A*fitted(fita)+(1-dataset.Z$A)*(1-fitted(fita)))^(-1)
  fitc.mar.stable <- glm(cbind(C,1-C)~A+U1+U2+U3,family = binomial(link = "logit"),data = dataset.Z,
                         weights = weighta)
  fitm.mar.stable <- glm(cbind(M,1-M)~A+U1+U2+U3,family = binomial(link = "logit"),data = dataset.Z,
                         weights = weighta)
...
do.oneZ.mca <-function(trials)
{
  ...
  fitm.mar <- glm(M~A+U1+U2+U3,family = binomial(link = "logit"),data = dataset.Z)
  fitc.mar <- glm(C~A+U1+U2+U3,family = binomial(link = "logit"),data = dataset.Z)
  fita <- glm(A~U1+U2+U3,family = binomial(link = "logit"),data = dataset.Z)
  fity <- lm(Y~A+U1+U2+U3+C+M + A*C+A*M+U1*U2+U2*U3+U1*U3,data = dataset.Z)
...
do.oneZ.mcy <-function(trials)
{
  ...
  fitc.mar <- glm(C~A+U1+U2+U3,family = binomial(link = "logit"),data = dataset.Z)
  fita <- glm(A~U1+U2+U3+U1*U2+U2*U3+U1*U3,family = binomial(link = "logit"),data = dataset.Z)
  fity <- lm(Y~A+U1+U2+U3+C+M,data = dataset.Z)
  ...
  fity.stable <- lm(Y~A+U1+U2+U3+C+M,data = dataset.Z,weights=weight1)
...
result2.Z.mcy <- matrix(unlist(result.Z.mcy),ncol = B)
...
##
library(xtable)
xtable(res.final,digits = 1)
xtable(res.final.sd,digits = 1)
##
